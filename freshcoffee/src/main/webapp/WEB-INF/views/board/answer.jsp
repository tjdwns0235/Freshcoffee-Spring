...
<body>
	...
	<section class="content">
		<div class="box">
			<form action="${path}/board/answer" name="frm_board" id="frm_board" method="POST" > <!--첨부파일 보내려면 방식이 POST여야 함!  -->
				<input type="hidden" value="${one.bno}" name="bno">
				<div class="insert_title">
					<h3>Q & A</h3>
					<label for="title"><h4>제목</h4></label>
					<span class="title_input"><input type="text" name="title" id="title" placeholder="제목을입력해주세요" value="RE: ${one.title}" readonly="readonly"></span>
					<span class="boardinsert_err"></span>
				</div>
	
				<div class="insert_Content">
					<label for="content"><div class="content_MiniTitle">내용</div></label>
					<textarea name="content" id="registerInsert" placeholder="내용을 입력해주세요!">${one.content}</textarea>
